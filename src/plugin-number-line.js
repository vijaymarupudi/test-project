...
class NumberLinePlugin {
  ...
  trial(display_element, trial, callback) {
      /*
...
export class jsPsychNumberLine {
  ...
  trial(display_element, trial, on_load) {
    // this = instance of the jsPsychNumberLine class
    const numberLine = new NumberLinePlugin()

    // this is where you'd call the important method
    numberLine.trial(display_element, trial, (data) => {
...
// outside: this is an instance of Number

var regular = function(x) {
  console.log(x)
...
// this = instance of Number
var arrow = (x) => {
  console.log(x)
  // this = is the same instance of Number
}
